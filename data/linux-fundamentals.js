...
function lesson(
    ...
    return {
        ...
        subtitle:
            extra.subtitle ||
            `Learn ${title} from a Linux and cybersecurity perspective.`,
...
export const linuxFundamentals = {
    ...
    longDescription:
        "Linux Fundamentals introduces students to the Linux operating system from an administration and cybersecurity perspective. Students learn how to navigate the filesystem, work with files, manage users and permissions, inspect processes and services, configure networking, use package managers, write basic Bash scripts and apply fundamental Linux security practices.",
    ...
    objectives: [
        ...
        "Create, modify, move and remove files and directories.",
        ...
        "Understand Linux logging and security fundamentals.",

        "Apply Linux administration skills in cybersecurity environments."
    ...
    modules: [
...

        {
            ...
            description:
                "Understand what Linux is, where it is used and how to begin working with the Linux command line.",
            ...
            lessons: [
                ...
                lesson(
                    ...
                    "30 minutes",
                    {
                        ...
                        subtitle:
                            "Understand Linux, distributions, the kernel and why Linux matters in cybersecurity.",

                        objectives: [

                            "Define Linux.",

                            "Understand the difference between Linux and a Linux distribution.",

                            "Explain the purpose of the Linux kernel.",

                            "Recognize why Linux is widely used in cybersecurity."
                        ...
                        introduction: `
                            ...
                            <p>
                                Linux is a family of Unix-like operating systems built around the Linux kernel.
                                It powers servers, cloud platforms, embedded systems, mobile devices,
                                cybersecurity tools and many of the systems that make up the modern Internet.
                            </p>

                            <p>
                                Linux is especially important in cybersecurity because security professionals
                                frequently work with Linux servers, security appliances, cloud workloads and
                        ...
                        body: `
                            ...
                            <p>
                                ...
                                It manages hardware resources such as memory, CPU time,
                            ...
                            <p>
                                A Linux distribution combines the Linux kernel with utilities,
                                package-management systems, software repositories and user interfaces.
                            </p>

                            <p>
                                Popular distributions include Ubuntu, Debian, Fedora,
                                Red Hat Enterprise Linux, Arch Linux and Kali Linux.
                            </p>
                            ...
                            <div class="lesson-callout">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Kali Linux is designed specifically for penetration testing
                                        and security research, but understanding ordinary Linux
                                        administration is more important than simply knowing Kali tools.
                                    </p>
                            ...
                            <h2>Why Security Professionals Learn Linux</h2>

                            <p>
                                Linux appears throughout cybersecurity environments.
                                Web servers, databases, containers, cloud systems,
                                firewalls and security monitoring platforms frequently run Linux.
                            </p>

                            <p>
                                Penetration testers also use Linux because many security
                                utilities are designed around Unix-style command-line workflows.
                            </p>
                        ...
                        keyConcepts: [
...

                            {
                                ...
                                description:
                                    "The core operating-system component responsible for managing hardware and system resources."
...

                            {
                                ...
                                description:
                                    "A Linux distribution designed for penetration testing and security research."
                        ...
                        quiz: [

                            {
                                ...
                                question:
                                    "What is the core component of a Linux operating system?",
...

        {
            ...
            description:
                "Understand the Linux directory hierarchy and how files and devices are organized.",
...

        {
            ...
            description:
                "Learn how to create, inspect, copy, move, search and remove Linux files and directories.",
...

        {
            ...
            description:
                "Understand Linux identities, ownership and access permissions.",
...

        {
            ...
            description:
                "Learn how Linux processes run and how system services are managed.",
...

        {
            ...
            description:
                "Use Linux networking tools to inspect interfaces, routing, connections and connectivity.",
...

        {
            ...
            description:
                "Install, update and remove Linux software securely.",
...

        {
            ...
            description:
                "Learn Bash fundamentals and automate simple Linux tasks.",
...

        {
            ...
            description:
                "Apply fundamental security concepts to Linux systems.",
...

        {
            ...
            description:
                "Bring Linux administration, networking and security concepts together.",
